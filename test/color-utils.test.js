...
describe("colorDistance", () => {
  ...
  test("returns Infinity for unparseable", () => {
    expect(colorDistance("notacolor", "#ff0000")).toBe(
...
describe("extractCssProperty", () => {
  test("extracts CSS property", () => {
    expect(extractCssProperty("  background-color: #ff0000;")).toBe(
      "background-color"
    );
  ...
  test("extracts JS property", () => {
    expect(extractCssProperty("  backgroundColor: '#ff0000',")).toBe(
      "backgroundColor"
    );
  });
